...
n=4;m=1;
figure(3)
sgtitle('X,Y,Z Over time - Vertical Short Figure 8')
...
n=4;m=1;
figure(2)
sgtitle('Thrusts and Rates over Time - Vertical Short Figure 8')
